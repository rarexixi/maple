...
import ${commonPackage}.model.IxUser;
...
public class ControllerAspect {
    ...
    public ControllerAspect() {
        Class<IxUser> userClass = IxUser.class;
     ...
     * @param user   DMP用户
     */
    private void setUsers(final Method method, final Object[] args, final IxUser user) {
     ...
     * @param user  DMP用户
     */
    private void setUsers(final String[] types, final Object obj, final IxUser user, Map<String, Object> fieldValueMap) {
        if (obj == null) {
            return;
        }
