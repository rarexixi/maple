<template>
  <a-breadcrumb separator="/">
    ...
    <a-breadcrumb-item>数据源类型列表</a-breadcrumb-item>
  </a-breadcrumb>
  ...
  <div class="list-table">
    ...
    <a-table :columns="columns" :data-source="dataList" :row-selection="rowSelection" :scroll="{ x: 1300 }" :pagination="false"
             :row-class-name="(record, index) => (index % 2 === 1 ? 'table-striped' : null)" row-key="typeCode" size="small">
