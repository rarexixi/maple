...
import org.xi.maple.sink.*;
import org.xi.maple.source.*;
import org.xi.maple.transform.*;
...
public class PluginUtil {
    ...
    private static Map<String, Class<?>> getSourcePlugins() {
        ...
        classMap.put("managed_jdbc", org.xi.maple.source.ManagedJdbcSource.class);
    ...
    private static Map<String, Class<?>> getSinkPlugins() {
        Map<String, Class<?>> classMap = new HashMap<>();
        classMap.put("managed_jdbc", org.xi.maple.sink.ManagedJdbcSink.class);
