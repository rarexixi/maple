...
public class JsonUtils {
    ...
    public static <T> T convertValue(Map<String, Object> node, Class<T> clazz) throws IOException {
        if (node == null) {
            return null;
        }
        ObjectMapper mapper = new ObjectMapper();
    ...
    public static <T> T convertValue(Map<String, Object> node, Class<T> clazz, T defaultValue) {
        try {
