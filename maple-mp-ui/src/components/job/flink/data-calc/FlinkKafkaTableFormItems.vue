...
import PhysicalColumnsFormItems from "@/components/job/flink/data-calc/column/EditablePhysicalColumnsFormItems.vue";
...
const { operationType, datasourceTypes = [] } = defineProps<{
...
<template>
  ...
  <a-form-item name="topic" label="topic" class="form-item-360">
    <a-input v-model:value="topic" />
  </a-form-item>
  <a-form-item name="groupId" label="group id" class="form-item-360">
    <a-input v-model:value="groupId" />
  </a-form-item>
  <a-flex-br />
  <PhysicalColumnsFormItems v-model:physical-columns="physicalColumns" />
  <MetadataColumnsFormItems v-model:metadata-columns="metadataColumns" :metadata-type="'kafka'"
