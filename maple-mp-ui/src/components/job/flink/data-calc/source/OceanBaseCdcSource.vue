...
import type { OceanBaseCdcSourceConfig } from "@/composables/flink-jobs"
...
const {value, name} = defineProps<{
  value: OceanBaseCdcSourceConfig,
  name: string,
}>()
...
const datasourceOptions = computed(() => getDatasourceOptions(datasourceList.value, 'oceanbase'))
