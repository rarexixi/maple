...
import type { MysqlCdcSourceConfig } from "@/composables/flink-jobs"
...
const datasourceOptions = computed(() => getDatasourceOptions(datasourceList.value, 'mysql'))
