...
import type { SqlServerCdcSourceConfig } from "@/composables/flink-jobs"
...
const {value, name} = defineProps<{
  value: SqlServerCdcSourceConfig,
  name: string,
}>()
...
const datasourceOptions = computed(() => getDatasourceOptions(datasourceList.value, 'sqlserver'))
