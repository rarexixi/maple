...
import type { TidbCdcSourceConfig } from "@/composables/flink-jobs"
...
const datasourceOptions = computed(() => getDatasourceOptions(datasourceList.value, 'tidb'))
