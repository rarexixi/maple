  ...
  <a-form :name="name" :model="value" :validate-messages="validateMessages">
    <a-row>
      <a-col v-bind="layout.cols.small">
        <a-form-item name="targetDatabase" label="目标库" :rules="[{ required: true }]"
      ...
      <a-col v-bind="layout.cols.small">
        <a-form-item name="targetTable" label="目标表" :rules="[{ required: true }]"
                     :label-col="layout.labelCols.small">
      ...
      <a-col v-bind="layout.cols.small">
        <a-form-item name="writeAsFile" label="文件优先" :rules="[{ required: true }]"
                     :label-col="layout.labelCols.small">
          <a-checkbox v-model:checked="value!.writeAsFile" />
        </a-form-item>
      </a-col>
      <a-col v-bind="layout.cols.small">
        <a-form-item name="strongCheck" label="强校验" :rules="[{ required: true }]"
                     :label-col="layout.labelCols.small">
      ...
      <a-col v-bind="layout.cols.small">
        <a-form-item name="sourceTable" label="来源表" :rules="[{ required: true }]"
                     :label-col="layout.labelCols.small">
