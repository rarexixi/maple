...
public class UpsertKafkaSink extends MapleSink<UpsertKafkaSink.Config> {

    public UpsertKafkaSink(TableEnvironment tableEnv, Map<String, String> gv) {
        super(tableEnv, gv);
    }

    @Data
    public static class Config extends SinkConfig {
